...
A **real** run of the tagout pipeline (2026-07-22), executed with RoselineMCP against a scratch copy of `samples/LegacyShop`. Every number and diff below is captured tool output, not a mock-up.
